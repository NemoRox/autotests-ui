...
def test_empty_courses_list():
    with (sync_playwright() as playwright):
        ...
        registration_form_button = page.get_by_test_id('registration-page-registration-button')
    ...
    with (sync_playwright() as playwright):
        ...
        courses_list_title_text = page.get_by_test_id('courses-list-toolbar-title-text')
        expect(courses_list_title_text).to_be_visible()
        expect(courses_list_title_text).to_contain_text('Courses')
        ...
        expect(courses_list_empty_view_title_text).to_contain_text('There is no results')
